...
import 'package:collegeapp/pages/timeline.dart';
...
class _HomeState extends State<Home> {
  ...
  createUserInFirestore() async{
    ...
    // 3) get user name from create account, use it to make new user 
    //document in users collection
      ...
      // make new user their own follower (to include their posts in
      // their timeline)
      await followersRef
        .document(user.id)
